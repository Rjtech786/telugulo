...
// NOTE: live web research now lives in ./research.ts (Gemini Google Search
// grounding). The old Google-News-link fetching was removed — those redirect
// links returned Google JS pages, not article text.
